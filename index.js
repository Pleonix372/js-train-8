...
function getUsersFromDatabase(array) {
  ...
  const arr = Array.from(
    array,
    (elem, index) => {
      // return `id: ${id}, firstName: ${name}, years: ${age}`;
      return elem;
    },
    array
  );
...
function findElementIndexes(arr, element) {
  ...
  //   let ind = [];
  //   if (ind1 >= 0) {
  //     let ind = ind.concat(...ind1);
  //     return ind;
  //   }
  //   if (ind2 !== ind1) {
  //     let ind = ind.concat(...ind2);
  //     return ind;
  //   }
  //   return ind;
  // } else {
...
function copyAndSwapElements(arr, target, start, end) {
  ...
  if (arr.length > target && arr.length > start && arr.length > end) {
...
function customEvery(arr, condition) {
  ...
  //   if (Array.isArray(arr)) {
  //     const arr1 = arr.every((elem) => elem == condition);
  //     return arr1;
  //   } else {
  //     return false;
  //   }
...
function customIncludes(arr, element) {
  ...
  // if (Array.isArray(arr)) {
  //   let index = arr.includes(element);
  //   let filterIndex = arr.filter(value) => element;
